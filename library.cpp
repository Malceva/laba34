...
Matrix operator+(const Matrix &m1, const Matrix &m2) {
    ...
    for (int i = 0; i < m1.rank; i++){
        for (int j = 0; j < m1.rank; j++) {
            temp.matrix[i].set(j, m1.matrix[i].get(j) + m2.matrix[i].get(j));
        }
    }
    return temp;
}
...
Matrix operator-(const Matrix &m1, const Matrix &m2) {
    Matrix temp (m1.rank);    for (int i = 0; i < m1.rank; i++){
        for (int j = 0; j < m1.rank; j++) {
            temp.matrix[i].set(j, m1.matrix[i].get(j) - m2.matrix[i].get(j));        }
    }
    return temp;}
    ...
    for (int i = 0; i < m1.rank; i++) {
        for (int j = 0; j < m1.rank; j++) {
            for (int k = 0; k < m1.rank; k++) {
                temp.matrix[i].set(j, m1.matrix[i].get(k) * m2.matrix[k].get(j) + temp.matrix[i].get(j));
            }
        }
    }
    return temp;
